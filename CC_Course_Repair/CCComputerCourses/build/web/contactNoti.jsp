                ...
                <div class="course">
                    ...
                    <div class="form">
                        ...
                        <form action="contact" method="POST">
                            <input type="text" name="name" value="${name}" placeholder="Write your name here" readonly/>
                            <input type="email" name="email" value="${email}" placeholder="Write your email here" readonly/>
